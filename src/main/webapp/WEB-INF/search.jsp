...
<body>
	<div class="container">
		...
		<form action="searchId.do" method="post">
			<label for="filmId" class="form-label">Enter Film ID</label> 
			<small>(or <a href="searchKeyword.do"> search by keyword</a>)</small>
			<input
				type="text" class="form-control form-control-lg" name="filmId" /> <input
				type="submit" class="btn btn-primary m-2" value="Search" />
		</form>
	</div>
	<script
